...
public class Main implements ModInitializer {
    ...
    public MutableObjectExtended<CheatMode> STATUS;
    ...
    public void onInitialize() {
        instance = this;
        this.STATUS = new MutableObjectExtended<>(CheatMode.ENABLED);
        MiniutilsGui.instance = new MiniutilsGui();
        ModuleManager.initGuiElements();
        MiniutilsGui.instance.add(new Enum<CheatMode>("MiniUtils mode", "MiniUtils mode", Main.instance.STATUS, this::statusChange),
                0, 460, 120, 15, MiniutilsGui.instance.root);
